...
#define MEM_SVC_STACK		(MEM_ABORT_STACK + EXCEPTION_STACK_SIZE)	// expands down
#define MEM_IRQ_STACK		(MEM_SVC_STACK + EXCEPTION_STACK_SIZE)	// expands down
...
#define USER_MODE_TASK_PAGE_START (MEM_COHERENT_REGION + MEGABYTE)
#define MAX_USER_MODE_TASK_PAGES 10
#define USER_MODE_TASK_PAGE_END (USER_MODE_TASK_PAGE_START + MAX_USER_MODE_TASK_PAGES*MEGABYTE)

#define MEM_HEAP_START		USER_MODE_TASK_PAGE_END
#else
